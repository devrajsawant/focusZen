  ...
  const CreateTaskForm = (
    <div className="bg-white/80 backdrop-blur-sm p-5 rounded-2xl border border-gray-100 shadow-sm">
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        />
        <label htmlFor="checklistToggle" className="text-sm text-slate-700">
    ...
    <div className="min-h-screen font-sans p-4 sm:p-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <aside className="w-full md:w-[30%] hidden md:block">
              <div className="sticky top-6">{CreateTaskForm}</div>
            </aside>
          </div>
        </div>
      </div>
      ...
      >
        <div className="px-3 pb-safe">
          <div className="bg-amber-600 rounded-t-2xl">
            <div className="flex items-center justify-end ">
              <button
                onClick={() => setIsDrawerOpen(false)}
                className="p-2 rounded-md text-white hover:bg-slate-100"
                aria-label="Close"
              >
            ...
            {/* Put the same form inside the drawer */}
            {CreateTaskForm}
          </div>
        </div>
      </div>
